function [] = run(arena,pos_body,pos_head,vec_tail,vec,con,per,w,t_w,s,t_run,t)
if t_run<10
    ...
    run(arena,pos_body,pos_head,vec_tail,vec,con,per,w,t_w,s,t_run,t);
end
...
if rand>p_run_terminate
    run(arena,pos_body,pos_head,vec_tail,vec,con,per,w,t_w,s,t_run,t);
else turn (arena,pos_body,pos_head,vec_tail,vec,con,per,0,t);
